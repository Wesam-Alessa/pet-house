...
class GetUserDataByIDUseCase extends BaseUseCase<UserModel, UserParameters> {
  final BaseUserDataRepository baseUserDataRepository;

  GetUserDataByIDUseCase(this.baseUserDataRepository);
  
  @override
  Future<Either<Failure, UserModel>> call(UserParameters parameters)async {
     return await baseUserDataRepository.getUserDataByID(parameters);
  }
