...
class SignUpUseCase extends BaseUseCase<UserModel, UserParameters> {
  final BaseUserDataRepository baseUserDataRepository;

  SignUpUseCase(this.baseUserDataRepository);
  
  @override
  Future<Either<Failure, UserModel>> call(UserParameters parameters)async {
     return await baseUserDataRepository.signup(parameters);
  }
